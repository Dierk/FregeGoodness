...
Values never change. 42 is 42 and when you apply it to the function
`(+1)` which returns 43 then 42 still remains to be 42.
...
Immutable data structures can often alleviate that burden by just copying or compare
