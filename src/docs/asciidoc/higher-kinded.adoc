...
1. A proper type has kind `\*` Examples are `Int`, `[Int]` or `Int → Int` Types with kind `*` can be inhabitated by values, for example `42`, `[1,2,3]` or `\n → n+1`
